# Polymarket 项目持续优化手册 (Optimization Playbook V3.6)
...
> **最后更新**：2026-09-03 V3.6 (Garman-Klass 真实极值波动率估计器 + EWMA 衰减平滑落地、消除趋势均值漂移误杀释放 20%~30% 良性机会、228 项全量单测全绿、生产节点平滑热更验证完毕)
